...
class BookingList(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self, **kwargs):
        ...
        if not self.request.user.is_staff:
            ...
            # Display list of bookings for the next 7 days for all staff members
            ...
            # Display list of bookings for the current day and current staff member
            queryset = self.model.objects.filter(
...
def delete_booking(request, booking_id):
    ...
    The view receives a booking id and use it to handle the deletion of the record
    """
...
class MakeBooking(LoginRequiredMixin, TemplateView):
    ...
    The view returns the context based on the request and data submitted
    in the form
    """
...
def get_appointment_times(staff_id, appointment_date):
   ...
   # split day into 30 minutes appointments
    ...
    while start_date < end_date:
        ...
        start_date = start_date + timedelta(minutes=APPOINTMENT_DURATION)
